...
**The candidate:**
- id: `R4-S64`
- one_liner: For Singapore buyers of Australian vegetables and fruit, use Landsat/Sentinel irrigation persistence to flag supplier districts shifting from irrigated production to fallow before import prices move.
- delta_claim: Detects supplier-capacity contraction from irrigation persistence, not vegetation-index crop health.
- region: singapore_source_basket
- bucket: satellite
- seed_urls: [{"url": "https://data.gov.sg/datasets/d_e7db30312e09879c09e0fd9dbe093878/view", "date": "2026-09-09", "title": "Import Price Index, By Commodity Division", "tier": "A", "note": "data.gov.sg publishes Singapore vegetable and fruit import price index series."}, {"url": "https://www.sfa.gov.sg/news-publications/newsroom/singapore-food-statistics-2025", "date": "2026-05-08", "title": "Singapore Food Statistics 2025", "tier": "A", "note": "SFA frames Singapore's food supply as import-dependent and disruption-sensitive."}]
- today: 2026-09-18
- depth: normal
