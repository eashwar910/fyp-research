...
**The candidate:**
- id: `R4-S110`
- one_liner: For Malaysian drone-service QA teams, compare MOPAD with Roboflow Oil Palm Using UAV images to reject client orthomosaics whose crown spacing, scale, or preprocessing sits outside training data.
- delta_claim: Outputs dataset-shift rejection before plantation counts rather than a higher-mAP detector.
- region: malaysia
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www.sciencedirect.com/science/article/pii/S0924271621000083", "date": "2021-03", "title": "Growing status observation for oil palm trees using Unmanned Aerial Vehicle (UAV) images", "tier": "A", "note": "MOPAD publisher page describes a public UAV oil-palm dataset."}, {"url": "https://universe.roboflow.com/palm-oil-d5b7f/oil-palm-using-uav/dataset/1", "date": "2024-01-11", "title": "OIL PALM USING UAV", "tier": "A", "note": "Roboflow page gives a CC BY 4.0 UAV oil-palm dataset with download formats and 3,499 images."}]
- today: 2026-09-18
- depth: normal
