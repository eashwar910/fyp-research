...
**The candidate:**
- id: `R4-S142`
- one_liner: Globally, turn FAO FLAPP loss surveys plus phone photos into a loss-cause sorter that shows whether tomatoes died from harvest timing, transport damage or storage delay.
- delta_claim: links visible damage classes to FLAPP value-chain loss causes
- region: global
- bucket: standout
- seed_urls: [{"url": "https://www.fao.org/platform-food-loss-waste/food-loss/fao-flapp/en", "date": "2025-08-28", "title": "FAO Food Loss App", "tier": "A", "note": "FAO says FLAPP tracks loss stages and causes and is used in over 38 countries."}]
- today: 2026-09-18
- depth: normal
