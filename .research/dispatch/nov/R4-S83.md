...
**The candidate:**
- id: `R4-S83`
- one_liner: For Indian millet breeders, use the TiHAN/ICRISAT UAV hyperspectral pearl-millet dataset to output the earliest flight date when water-stress separation is trustworthy by genotype group.
- delta_claim: earliest trustworthy stress-date selection for breeding trials
- region: india
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://oar.icrisat.org/13212/", "date": "2025-07-08", "title": "UAV-Borne Hyperspectral Imaging Dataset of Pearl Millet Canopy Water Stress", "tier": "A", "note": "ICRISAT repository describes UAV HSI pearl millet water-stress dataset and public-use intent."}, {"url": "https://github.com/sankaraug/HSI-PearlMillet-WaterStress", "date": "2025-02", "title": "HSI-PearlMillet-WaterStress", "tier": "B", "note": "Repository describes request-access dataset, benchmark code and 282-band UAV HSI patches."}]
- today: 2026-09-18
- depth: normal
