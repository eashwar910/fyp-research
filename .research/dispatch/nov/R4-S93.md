...
**The candidate:**
- id: `R4-S93`
- one_liner: For EU paying agencies auditing GAEC 8, use French, Dutch, and Austrian orthophotos to benchmark hedgerow-loss detectors across 20 cm, 8 cm, and 29 cm imagery, with resolution-transfer error as the output.
- delta_claim: measures cross-resolution transfer error for hedgerow-change detection
- region: eu
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://data.overheid.nl/en/dataset/80812-luchtfoto-beeldmateriaal-2025-5cm---8cm-rgb-open-data", "date": "2026-08-13", "title": "Luchtfoto Beeldmateriaal 2025 5cm / 8cm RGB open data", "tier": "A", "note": "Dutch data portal lists 2025 open aerial orthomosaics at 5 cm and 8 cm under CC BY 4.0."}, {"url": "https://basemap.at/release-infos/", "date": "2025-08-29", "title": "basemap.at release infos", "tier": "A", "note": "Austrian basemap release page says the orthophoto product was updated on 29 Aug 2025 with 2024 flight data."}]
- today: 2026-09-18
- depth: normal
