...
**The candidate:**
- id: `R4-S108`
- one_liner: For Malaysian smallholder extension officers, use MOPAD UAV imagery to output a block-level confidence score for whether sparse palms mean vacant planting points, young replanting, or uncertain annotations.
- delta_claim: Makes vacancy ambiguity and confidence the output instead of raw palm detections.
- region: malaysia
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www.sciencedirect.com/science/article/pii/S0924271621000083", "date": "2021-03", "title": "Growing status observation for oil palm trees using Unmanned Aerial Vehicle (UAV) images", "tier": "A", "note": "Paper describes UAV oil-palm status labels and a vacancy-detection workflow."}, {"url": "https://prestasisawit.mpob.gov.my/en/palmnews/news/39893", "date": "2026-09-02", "title": "Agrobank to fully disburse RM200mil under oil palm smallholder scheme by October", "tier": "B", "note": "MPOB clipping says officers upload site-visit data and plantation photos for financing assessment."}]
- today: 2026-09-18
- depth: normal
