...
**The candidate:**
- id: `R4-S118`
- one_liner: For Malaysian plantation managers, use iRadar hyperspectral tree-crown data and MOPAD visible-status labels to separate spectral Ganoderma suspicion from ordinary yellowing or mismanagement.
- delta_claim: Disentangles disease suspicion from visible management stress using two accessible UAV data classes.
- region: malaysia
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www.iradar.com.my/dataset/", "date": "2026-06-03", "title": "iRadar Dataset Portal", "tier": "A", "note": "iRadar provides a controlled-access hyperspectral tree-crown dataset for academic research."}, {"url": "https://www.sciencedirect.com/science/article/pii/S0924271621000083", "date": "2021-03", "title": "Growing status observation for oil palm trees using Unmanned Aerial Vehicle (UAV) images", "tier": "A", "note": "MOPAD includes visible UAV labels for yellowish and mismanaged palms."}]
- today: 2026-09-18
- depth: normal
