...
**The candidate:**
- id: `R4-S146`
- one_liner: Globally, make a Foldscope saffron verifier that asks the user to stain one strand, then highlights the missing papillae that reveal fake lookalikes.
- delta_claim: explains the visible biological feature behind the fraud verdict
- region: global
- bucket: standout
- seed_urls: [{"url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC9417335/", "date": "2022-08", "title": "Low-cost rapid identification of fake saffron using Foldscope and ML", "tier": "A", "note": "Open paper describes smartphone Foldscope images and ML for genuine/fake saffron classification."}]
- today: 2026-09-18
- depth: normal
