...
**The candidate:**
- id: `R4-S131`
- one_liner: For JTC-tenant indoor vertical-farm operators such as Singrow, mine the periodic BCA TR78 drone facade-inspection thermal imagery their industrial buildings already undergo to pre-empt HVAC or cooling-system failures before they cause temperature-sensitive crop loss, instead of waiting for in-house IoT alerts.
- delta_claim: Pre-empts HVAC failure from inspection thermal data already collected, not an added IoT sensor layer.
- region: singapore
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www1.bca.gov.sg/resources/newsroom/new-regulations-for-periodic-inspection-of-building-fa-ades-to-start-from-1-january-2022/", "date": "2021-10-21", "tier": "A", "title": "New Regulations for Periodic Inspection of Building Facades to start from 1 January 2022", "note": "BCA press release on TR78:2020, the world-first Technical Reference for drone facade inspections; BCA-recognised for PFI submissions."}, {"url": "https://www.singrow.com/jobs", "date": "2026-09", "tier": "A", "title": "Jobs (All) - Singrow", "note": "Confirms Singrow is an operating Singapore vertical-farm company hiring for agritech integration."}]
- today: 2026-09-18
- depth: normal
