...
**The candidate:**
- id: `R4-S47`
- one_liner: For Cameron Highlands district officers in Malaysia, type new Sentinel-1/2 land-clearing signals as terrace extension, farm-road cut, greenhouse block, or non-farm clearing, instead of a generic encroachment alert.
- delta_claim: classifies the clearing mechanism that enforcement officers act on
- region: malaysia
- bucket: satellite
- seed_urls: [{"url": "https://www.mosti.gov.my/berita/satelit-remote-sensing-pantau-aktiviti-penerokaan-tanah-cameron-highlands/", "date": "2023-03-06", "title": "Satelit Remote Sensing Pantau Aktiviti Penerokaan Tanah Cameron Highlands", "tier": "A", "note": "MOSTI says MYSA and Cameron Highlands agencies monitor land-development activities with satellite remote sensing."}]
- today: 2026-09-18
- depth: normal
