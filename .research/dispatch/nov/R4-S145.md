...
**The candidate:**
- id: `R4-S145`
- one_liner: Globally, use smartphone videos under changing screen colours to map saffron purity across a sample so buyers can see fake filaments as a heatmap.
- delta_claim: turns a phone screen into a low-cost spectral scanner for food fraud
- region: global
- bucket: standout
- seed_urls: [{"url": "https://pure.qub.ac.uk/en/publications/rapid-and-low-cost-detection-of-saffron-crocus-sativus-l-adultera/", "date": "2024-09-03", "title": "Rapid and low-cost detection of saffron adulteration", "tier": "A", "note": "Paper reports smartphone video plus spectral-data fusion for saffron adulteration."}]
- today: 2026-09-18
- depth: normal
