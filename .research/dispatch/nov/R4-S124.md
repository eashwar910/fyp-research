...
**The candidate:**
- id: `R4-S124`
- one_liner: For SFA and HDB managing multi-storey-carpark rooftop vegetable farms, fuse the BCA TR78-mandated periodic drone thermal facade and roof inspection imagery these buildings already undergo with per-site harvest logs, to flag which rooftops are losing crop output to heat or waterproofing defects the inspection already photographed but never linked to farming outcomes.
- delta_claim: Links mandatory building-inspection thermal imagery to farm yield loss, a source no vertical-farm monitoring product uses.
- region: singapore
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www1.bca.gov.sg/resources/newsroom/new-regulations-for-periodic-inspection-of-building-fa-ades-to-start-from-1-january-2022/", "date": "2021-10-21", "tier": "A", "title": "New Regulations for Periodic Inspection of Building Facades to start from 1 January 2022", "note": "BCA press release on TR78:2020, the world-first Technical Reference for drone facade inspections; BCA-recognised for PFI submissions."}, {"url": "https://www.hdb.gov.sg/about-us/news-and-publications/press-releases/24032021-JTender-Closing-For-7-HDB-MSCP-Rooftop-Sites-For-Urban-Farming", "date": "2021-03-24", "tier": "A", "title": "Tender Closing For 7 HDB MSCP Rooftop Sites For Urban Farming", "note": "HDB press release confirming the multi-storey-carpark rooftop urban farming programme."}]
- today: 2026-09-18
- depth: normal
