...
**The candidate:**
- id: `R4-S60`
- one_liner: For Singapore importers receiving Malaysian produce by truck, compare declared farm districts with Sentinel-1/Sentinel-2 harvest-window plausibility to flag consignments whose claimed origin does not match crop activity.
- delta_claim: Uses source-farm phenology as an import-origin plausibility check, not crop classification.
- region: singapore_source_basket
- bucket: satellite
- seed_urls: [{"url": "https://www.sfa.gov.sg/news-publications/newsroom/2025/about-1-4-tonnes-of-illegally-imported-fresh-fruits-and-vegetables-seized", "date": "2025-04-08", "title": "About 1.4 tonnes of illegally imported fresh fruits and vegetables seized", "tier": "A", "note": "SFA says undeclared and under-declared fresh fruits and vegetables from Malaysia were seized."}, {"url": "https://www.customs.gov.sg/doing-business/quick-links-for-traders/tradenet/competent-authorities-requirements-for-controlled-items/singapore-food-agency/", "date": "2026-02-23", "title": "Singapore Food Agency requirements for controlled items", "tier": "A", "note": "Singapore Customs says fruit and vegetable imports are regulated by SFA and require licences and permits."}]
- today: 2026-09-18
- depth: normal
