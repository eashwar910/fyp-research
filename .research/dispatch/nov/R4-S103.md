...
**The candidate:**
- id: `R4-S103`
- one_liner: For vineyard robotics teams, use GrapeSLAM raw UAV side videos to output row-level geolocation uncertainty for vine observations, instead of trusting orthomosaic-derived plant positions as exact.
- delta_claim: propagates raw-video SLAM uncertainty to vine-row observations
- region: eu
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://zenodo.org/records/14658376", "date": "2025-01-09", "title": "GrapeSLAM", "tier": "A", "note": "Zenodo record provides 24 UAV RGB vineyard videos in Spain with flight trajectory metadata."}, {"url": "https://zenodo.org/records/15147343", "date": "2025-04-08", "title": "UAV Canyelles Vineyard Dataset", "tier": "A", "note": "Companion vineyard dataset includes raw RGB imagery, orthomosaics, point clouds and metadata."}]
- today: 2026-09-18
- depth: normal
