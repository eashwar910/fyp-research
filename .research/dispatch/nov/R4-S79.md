...
**The candidate:**
- id: `R4-S79`
- one_liner: For Indian paddy drone services, align IMPaCT-UAV RGB and multispectral frames to expose when red-edge maps are spatially shifted from visible canopy rows before prescriptions are generated.
- delta_claim: cross-sensor registration failure detection for prescription safety
- region: india
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://arxiv.org/abs/2601.01084", "date": "2026-06-24", "title": "IMPaCT-UAV Indian paddy dataset", "tier": "A", "note": "IMPaCT-UAV has paired RGB and four-band multispectral imagery."}, {"url": "https://www.pib.gov.in/PressReleasePage.aspx?PRID=1909215&lang=2&reg=48", "date": "2023-03-21", "title": "Funds for Kisan Drones", "tier": "A", "note": "PIB describes subsidies for Kisan Drone demonstrations and service providers."}]
- today: 2026-09-18
- depth: normal
