...
**The candidate:**
- id: `R4-S115`
- one_liner: For Malaysian plantation GIS teams, use MOPAD UAV detections to output geolocation uncertainty ellipses for individual unhealthy palms before they are converted into replanting work orders.
- delta_claim: Adds per-palm spatial uncertainty to work-order evidence rather than only class labels.
- region: malaysia
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www.sciencedirect.com/science/article/pii/S0924271621000083", "date": "2021-03", "title": "Growing status observation for oil palm trees using Unmanned Aerial Vehicle (UAV) images", "tier": "A", "note": "MOPAD provides large-area UAV images and tree-status detections."}, {"url": "https://prestasisawit.mpob.gov.my/en/palmnews/news/39893", "date": "2026-09-02", "title": "Agrobank to fully disburse RM200mil under oil palm smallholder scheme by October", "tier": "B", "note": "MPOB clipping describes plantation photographs in financing assessment."}]
- today: 2026-09-18
- depth: normal
