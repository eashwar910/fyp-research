...
**The candidate:**
- id: `R4-S141`
- one_liner: Globally, turn OpenET field-scale evapotranspiration into a water-saving replay where a farmer draws a field and sees the litres not pumped by one skipped irrigation.
- delta_claim: converts ET into counterfactual saved-water receipts for farm decisions
- region: global
- bucket: standout
- seed_urls: [{"url": "https://www.nasa.gov/centers-and-facilities/ames/ames-science/farming-with-data-openet-launches-new-tool-for-farmers-and-ranchers/", "date": "2025-03-04", "title": "OpenET launches FARMS", "tier": "A", "note": "NASA says OpenET FARMS gives farmers high-resolution ET water data."}, {"url": "https://www.nasa.gov/general/openet-launches-a-new-api/", "date": "2023-10-03", "title": "OpenET launches a new API", "tier": "A", "note": "NASA says the API supports irrigation scheduling and water management integration."}]
- today: 2026-09-18
- depth: normal
