...
**The candidate:**
- id: `R4-S150`
- one_liner: Globally, turn PlantVillage-style disease photos into an outbreak speedometer that shows when scattered farmer diagnoses become a moving epidemic front.
- delta_claim: detects spatial outbreak acceleration from diagnosis streams
- region: global
- bucket: standout
- seed_urls: [{"url": "https://www.cgiar.org/innovations/tumaini-an-ai-powered-mobile-app-for-pests-and-diseases", "date": "2021-01-24", "title": "Tumaini AI mobile app for pests and diseases", "tier": "A", "note": "CGIAR says Tumaini records diagnosis and geographic location for banana pest/disease reports."}]
- today: 2026-09-18
- depth: normal
