...
**The candidate:**
- id: `R4-S113`
- one_liner: For Malaysian plantation QA teams, use revised MOPAD labels from the oil-palm-condition YOLOv8 study to detect which original MOPAD label errors would flip a replanting subsidy verdict.
- delta_claim: Measures label-error impact on subsidy decisions, not detector leaderboard accuracy.
- region: malaysia
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www.tandfonline.com/doi/abs/10.1080/20964471.2025.2491881", "date": "2025-04", "title": "Classification of oil palm tree conditions from UAV imagery using the YOLO object detector", "tier": "A", "note": "Article states revised MOPAD labels and open materials are available via GitHub."}, {"url": "https://www.sciencedirect.com/science/article/pii/S0924271621000083", "date": "2021-03", "title": "Growing status observation for oil palm trees using Unmanned Aerial Vehicle (UAV) images", "tier": "A", "note": "Original MOPAD dataset and code are public."}]
- today: 2026-09-18
- depth: normal
