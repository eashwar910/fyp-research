...
**The candidate:**
- id: `R4-S152`
- one_liner: Globally, fuse OpenET with crop insurance polygons to make a drought-proof-of-care score: did the farmer irrigate enough before claiming drought damage?
- delta_claim: separates unavoidable drought from irrigation underuse evidence
- region: global
- bucket: standout
- seed_urls: [{"url": "https://www.nasa.gov/general/openet-launches-a-new-api/", "date": "2023-10-03", "title": "OpenET launches a new API", "tier": "A", "note": "NASA says OpenET API provides daily, monthly and annual ET at field scale."}]
- today: 2026-09-18
- depth: normal
