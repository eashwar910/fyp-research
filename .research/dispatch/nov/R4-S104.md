...
**The candidate:**
- id: `R4-S104`
- one_liner: For Italian salad growers using low-cost UAV scouting, use the public salad-weed UAV dataset to label frames as spray-ready, human-review, or unsafe-to-act from latency and annotation uncertainty.
- delta_claim: turns real-time weed detection into an action-safety classifier
- region: eu
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://www.mdpi.com/2079-9292/14/20/4082", "date": "2025-10", "title": "Low-Cost UAV System and Dataset for Real-Time Weed Detection in Salad Crops", "tier": "A", "note": "Paper describes a public Rome salad-crop UAV dataset and notes gaps in metadata and real-time validation."}, {"url": "https://aura-lab.org/datasets/", "date": "2026-09", "title": "AURA Lab datasets", "tier": "B", "note": "AURA Lab lists open UAV agricultural datasets including crop/weed imagery with raw and orthomosaic products."}]
- today: 2026-09-18
- depth: normal
