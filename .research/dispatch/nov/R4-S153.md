...
**The candidate:**
- id: `R4-S153`
- one_liner: Globally, build an elephant crop-raid decoy planner that places solar voice boxes only where acoustic deterrence would protect the most crop edge.
- delta_claim: optimizes deterrent placement from crop-damage response curves
- region: global
- bucket: standout
- seed_urls: [{"url": "https://wildlabs.net/en/comment/15076", "date": "2026-05", "title": "Ambiance Project Update: Lessons from Laikipia", "tier": "B", "note": "WILDLABS update reports reduced elephant crop raiding from human-voice playback units."}]
- today: 2026-09-18
- depth: normal
