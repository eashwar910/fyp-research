...
**The candidate:**
- id: `R4-S50`
- one_liner: For Malaysian rubber and palm buyers, use Sentinel-1/2 plus AlphaEarth embeddings to flag mixed smallholder parcels where commodity identity is uncertain enough to break EUDR due-diligence routing.
- delta_claim: outputs commodity-routing uncertainty for due diligence, not a crop map
- region: malaysia
- bucket: satellite
- seed_urls: [{"url": "https://environment.ec.europa.eu/news/commission-updates-product-scope-and-tools-support-eudr-2026-07-13_en", "date": "2026-07-13", "title": "Commission updates product scope and tools to support EUDR", "tier": "A", "note": "EC states EUDR covers seven commodities including palm oil and rubber."}, {"url": "https://developers.google.com/earth-engine/datasets/catalog/GOOGLE_SATELLITE_EMBEDDING_V1_ANNUAL", "date": "2025-11-17", "title": "Satellite Embedding V1", "tier": "A", "note": "Annual embeddings support clustering, classification and change detection without heavy local model training."}]
- today: 2026-09-18
- depth: normal
