...
**The candidate:**
- id: `R4-S101`
- one_liner: For EU UAV weed datasets, build a cross-dataset failure map from WeedsGalore and PhenoBench that labels whether errors come from sensor bands, growth stage, species ambiguity, or instance crowding.
- delta_claim: benchmarks failure causes across crops and sensors, not weed segmentation itself
- region: eu
- bucket: drone_and_aerial
- seed_urls: [{"url": "https://huggingface.co/datasets/Voxel51/weeds-galore", "date": "2025-02-18", "title": "WeedsGalore dataset", "tier": "A", "note": "WeedsGalore provides German maize UAV multispectral imagery across multiple dates and weed species."}, {"url": "https://www.phenobench.org/benchmarks.html", "date": "2026-02-18", "title": "PhenoBench benchmarks", "tier": "A", "note": "PhenoBench offers semantic, panoptic, plant, leaf and hierarchical benchmark tasks."}]
- today: 2026-09-18
- depth: normal
